...
#define PCIE_BAR0_ADDRESS   0x18800000
...
HI_S32 SamplePciv_HostStartPciv(PCIV_CHN PcivChn, PCIV_REMOTE_OBJ_S *pstRemoteObj,PICVB_ATTR_S *pstPicVbAttr)
{
    ...
    stPcivAttr.u32Count = 6;
    if (VIDEO_FORMAT_TILE_16x8 != pstPicVbAttr->enVideoFormat)
    {
    ...
    {
        stPcivAttr.u32BlkSize = AVS_GetPicBufferSize(stPcivAttr.stPicAttr.u32Width,stPcivAttr.stPicAttr.u32Height,
                                          pstPicVbAttr->enCompressMode,0);
    }
...
static HI_S32 SamplePcivInitMpp(HI_VOID)
{
    ...
    stVbConf.astCommPool[6].u64BlkSize   = 16588800;
    stVbConf.astCommPool[6].u32BlkCnt    = 6;
...
HI_S32 SampleInitPcie(HI_S32 *ps32PciLocalId,HI_S32 as32PciRmtId[HISI_MAX_MAP_DEV-1], HI_S32 *ps32AllPciRmtCnt)
{
    HI_S32 s32Ret;
    HI_S32 i;
...
HI_S32 SampleViVpssSlaveSendPicToHostVpssVoDisplayMode(HI_VOID)
{
    ...
    for (i=0; i<s32AllPciRmtCnt; i++)
    {
        ...
        /*bind vpss and venc in slave chip*/
        stBindInfo.SrcMod.enModId = HI_ID_VPSS;
        stBindInfo.SrcMod.s32DevId = 0;
        stBindInfo.SrcMod.s32ChnId = 0;
    ...
    for (i=0; i<s32AllPciRmtCnt; i++)
    {
        ...
        /*Unbind vpss and venc in slave chip*/
