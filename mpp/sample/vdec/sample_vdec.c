...
HI_S32 SAMPLE_H265_VDEC_VPSS_VO_ov9734(HI_VOID)
{
    ...
    *************************************************/
    for(i=0; i<u32VdecChnNum; i++)
    {
        ...
        astSampleVdec[i].u32Width                         = 1280;
        astSampleVdec[i].u32Height                        = 720;
    ...
    *************************************************/
    for(i=0; i<u32VdecChnNum; i++)
    {
        snprintf(stVdecSend[i].cFileName, sizeof(stVdecSend[i].cFileName), "stream_chn0.h265");
        ...
        stVdecSend[i].s32IntervalTime = 33;
        stVdecSend[i].u64PtsInit      = 0;
        stVdecSend[i].u64PtsIncrease  = 33333;
...
HI_S32 SAMPLE_H265_VDEC_VPSS_VO_ov6946(HI_VOID)
{
    VB_CONFIG_S stVbConfig;
    HI_S32 i, s32Ret = HI_SUCCESS;
    VDEC_THREAD_PARAM_S stVdecSend[VDEC_MAX_CHN_NUM];
    ...
    *************************************************/
    ...
    {
        astSampleVdec[i].enType                           = PT_H265;
        astSampleVdec[i].u32Width                         = 400;
        astSampleVdec[i].u32Height                        = 400;
        astSampleVdec[i].enMode                           = VIDEO_MODE_FRAME;
        astSampleVdec[i].stSapmleVdecVideo.enDecMode      = VIDEO_DEC_MODE_IP;
        astSampleVdec[i].stSapmleVdecVideo.enBitWidth     = DATA_BITWIDTH_8;
        astSampleVdec[i].stSapmleVdecVideo.u32RefFrameNum = 2;
...
#endif
{
    ...
    ******************************************/
    switch (*argv[1])
    {
        case '0':
        {
            s32Ret = SAMPLE_H265_VDEC_VPSS_VO_ov9734();
            break;
        }
        case '1':
        {
            s32Ret = SAMPLE_H265_VDEC_VPSS_VO_ov6946();
            break;
        }
        case '2':
        {
