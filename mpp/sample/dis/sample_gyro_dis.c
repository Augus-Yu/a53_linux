...
HI_S32 SAMPLE_DIS_GYRO(VO_INTF_TYPE_E enVoIntfType, DIS_GYRO_MODE_E enGyroMode)
{
    HI_S32 s32Ret               = HI_SUCCESS;
    HI_U32 u32BlkSize;
    SIZE_S stSize;
    ...
    *************************************************/
    ...
    if (enGyroMode == DIS_GYRO_MODE_DV)
    {
        ...
        if (1920 == stSize.u32Width && 1080 == stSize.u32Height)
        {
            ...
            stLDCV2Attr.stAttr.s32FocalLenX = 2281550 / 2;
            stLDCV2Attr.stAttr.s32FocalLenY = 2303229 / 2;
            stLDCV2Attr.stAttr.s32CoorShiftX = 191950 / 2;
            stLDCV2Attr.stAttr.s32CoorShiftY = 107950 / 2;
...
HI_S32 SAMPLE_DIS_IPC_GYRO(VO_INTF_TYPE_E enVoIntfType)
{
    return SAMPLE_DIS_GYRO(enVoIntfType, DIS_GYRO_MODE_IPC);
}

HI_S32 SAMPLE_DIS_DV_GYRO(VO_INTF_TYPE_E enVoIntfType)
{
    return SAMPLE_DIS_GYRO(enVoIntfType, DIS_GYRO_MODE_DV);
}
