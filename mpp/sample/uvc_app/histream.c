 ...
 *******************************************************/
static void _histream_pu_brightness_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
    uint16_t v = 50;
...
void _histream_pu_contrast_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
#if 0
    uint16_t v = 50;
...
void _histream_pu_hue_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
#if 0
    uint16_t v = 50;
...
void _histream_pu_power_line_frequency_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
#if 0
    uint8_t v = 0;
...
void _histream_pu_saturation_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
#if 0
    uint16_t v = 50;
...
void _histream_pu_white_balance_temperature_auto_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
#if 0
    uint8_t v = 0;
...
void _histream_pu_white_balance_temperature_ctrl(struct HiUvcDev *dev, uint8_t req, struct uvc_request_data *resp)
{
#if 0
    uint16_t v = 15000;
...
void histream_event_pu_control(struct HiUvcDev *dev,
                               uint8_t req,
                               uint8_t unit_id,
                               uint8_t cs,
                               struct uvc_request_data* resp)
{
    ...
    switch(cs)
    {
        case HIUVC_PU_BRIGHTNESS_CONTROL:
            _histream_pu_brightness_ctrl(dev, req, resp);
            break;
        case HIUVC_PU_HUE_CONTROL:
            //_histream_pu_hue_ctrl(dev, req, resp);
            //break;
        case HIUVC_PU_CONTRAST_CONTROL:
            //_histream_pu_contrast_ctrl(dev, req, resp);
            //break;
        case HIUVC_PU_SATURATION_CONTROL:
            //_histream_pu_saturation_ctrl(dev, req, resp);
            //break;
        case HIUVC_PU_WHITE_BALANCE_COMPONENT_AUTO_CONTROL:
            //break;
        case HIUVC_PU_WHITE_BALANCE_COMPONENT_CONTROL:
            //break;
        case HIUVC_PU_WHITE_BALANCE_TEMPERATURE_CONTROL:
            //_histream_pu_white_balance_temperature_ctrl(dev, req, resp);
            //break;
        case HIUVC_PU_WHITE_BALANCE_TEMPERATURE_AUTO_CONTROL:
            //_histream_pu_white_balance_temperature_auto_ctrl(dev, req, resp);
            //break;
        case HIUVC_PU_POWER_LINE_FREQUENCY_CONTROL:
...
void histream_event_pu_data(struct HiUvcDev *dev,
                        int unit_id,
                        int control,
 ...
 *******************************************************/
static void _histream_it_exposure_auto_mode_ctrl(struct HiUvcDev *dev,
                                                 uint8_t req,
                                                 struct uvc_request_data *resp)
{
    uint8_t v = 0x04;
...
static void _histream_it_exposure_auto_mode_set(struct HiUvcDev* dev,struct uvc_request_data *data)
{
    uint8_t v = 0x04;
...
static void _histream_it_exposure_ansolute_time_ctrl(struct HiUvcDev *dev,
                                                     uint8_t req,
                                                     struct uvc_request_data *resp)
{
    uint32_t v = 2000;
    ...
    switch (req)
    {
        ...
        case HIUVC_GET_CUR:
            ...
            break;
        case HIUVC_GET_MAX:
            //RLOG("exposure_ansolute_time HIUVC_GET_MAX\n");
            resp->length = 4;
            ...
            break;
        case HIUVC_GET_MIN:
            //RLOG("exposure_ansolute_time HIUVC_GET_MIN\n");
            resp->length = 4;
            resp->data[0] = 0x0a;
            resp->data[1] = 0x0;
            resp->data[2] = 0x0;
...
void histream_event_it_control(struct HiUvcDev *dev,
                               uint8_t req,
                               uint8_t unit_id,
                               uint8_t cs,
                               struct uvc_request_data *resp)
{
    ...
    switch(cs)
    {
        case HIUVC_CT_AE_MODE_CONTROL:
            //RLOG("HIUVC_CT_AE_MODE_CONTROL req %d--------\n",req);
            _histream_it_exposure_auto_mode_ctrl(dev, req, resp);
            break;
        case HIUVC_CT_EXPOSURE_TIME_ABSOLUTE_CONTROL:
            _histream_it_exposure_ansolute_time_ctrl(dev, req, resp);
            break;
        case HIUVC_CT_EXPOSURE_TIME_RELATIVE_CONTROL:
        case HIUVC_CT_AE_PRIORITY_CONTROL:
        default:
            //_histream_event_default_control(req, resp);
            resp->length = -EL2HLT;
            dev->request_error_code.data[0] = 0x06;
...
void histream_event_it_data(struct HiUvcDev *dev, int unit_id, int control, struct uvc_request_data *data)
{
    if (unit_id != 1) {
        return;
    }
 ...
 *******************************************************/
static void _histream_eu_h264_picture_type_control(uint8_t req, struct uvc_request_data *resp)
{
    switch (req)
    {
        case HIUVC_SET_CUR:
...
void histream_event_eu_h264_control(struct HiUvcDev *dev,
                                    uint8_t req,
                                    uint8_t unit_id,
                                    uint8_t cs,
                                    struct uvc_request_data* resp)
...
void histream_event_eu_h264_data(struct HiUvcDev *dev,
                                int unit_id,
                                int control,
                                struct uvc_request_data *data)
{
...
void histream_event_eu_camera_control(struct HiUvcDev *dev,
                                    uint8_t req,
                                    uint8_t unit_id,
                                    uint8_t cs,
                                    struct uvc_request_data* resp)
...
void histream_event_eu_camera_data(struct HiUvcDev *dev,
                                int unit_id,
                                int control,
                                struct uvc_request_data *data)
{
...
void release_histream(histream *stream)
{
}
