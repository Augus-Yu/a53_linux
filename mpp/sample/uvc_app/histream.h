...
extern void histream_event_pu_control(struct HiUvcDev *dev,
                               uint8_t req,
                               uint8_t unit_id,
                               uint8_t cs,
                               struct uvc_request_data* resp);

extern void histream_event_it_control(struct HiUvcDev *dev,
                               uint8_t req,
                               uint8_t unit_id,
                               uint8_t cs,
                               struct uvc_request_data *resp);

extern void histream_event_eu_h264_control(struct HiUvcDev *dev,
                                   uint8_t req,
                                   uint8_t unit_id,
                                   uint8_t cs,
                                   struct uvc_request_data *resp);

extern void histream_event_eu_camera_control(struct HiUvcDev *dev,
                                       uint8_t req,
                                       uint8_t unit_id,
                                       uint8_t cs,
                                       struct uvc_request_data *resp);
...
extern void histream_event_eu_h264_data(struct HiUvcDev *dev,
                                    int unit_id,
                                    int control,
                                    struct uvc_request_data *data);

extern void histream_event_pu_data(struct HiUvcDev *dev,
                                int unit_id,
                                int control,
                                struct uvc_request_data *data);

extern void histream_event_it_data(struct HiUvcDev *dev,
                                int unit_id,
                                int control,
                                struct uvc_request_data *data);

extern void histream_event_eu_camera_data(struct HiUvcDev *dev,
                                    int unit_id,
                                    int control,
                                    struct uvc_request_data *data);
