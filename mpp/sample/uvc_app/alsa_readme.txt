...
2.compile alsa-lib
	1) Store the downloaded alsa-lib-1.1.7.tar.bz2 in the smp/a53_linux/mpp/sample/uvc_app/alsa/opensource directory.
	2) In the linux server, enter the smp/a53_linux/mpp/sample/uvc_app/alsa/opensource directory and execute the following command:
	tar -xjvf alsa-lib-1.1.7.tar.bz2
	cd ./alsa-lib-1.1.7/
	mkdir -p /home/install/alsa-lib-1.1.7/
	./configure --host=arm-himix200-linux --prefix=/home/install/alsa-lib-1.1.7/ --enable-static=no --enable-shared=yes --with-configdir=/home/audio/alsa/ --disable-python
	make
	make install
