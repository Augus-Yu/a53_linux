...
static HI_S32 CreateImage(IVE_IMAGE_S *pstSrcImage, BgrInfo *bgrInfo, IVE_HANDLE *hIveHandle, ImageInfo *imageInfo)
{
    ...
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "createImageByIVE fail:%#x\n", s32Ret);
    ...
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "HI_MPI_IVE_Sub fail:%#x\n", s32Ret);
...
static HI_S32 subImageByIVE(IVE_IMAGE_S *pstSrcImage, HI_U8 B, HI_U8 G, HI_U8 R, IVE_IMAGE_S *pstDstImage)
{
    ...
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "SetImageInfo fail:%#x\n", s32Ret);

    s32Ret = CreateImage(pstSrcImage, &bgrInfo, &hIveHandle, &imageInfo);
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "CreateImage fail:%#x\n", s32Ret);
    ...
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "HI_MPI_IVE_Query fail:%#x\n", s32Ret);
...
HI_S32 resizeImageByIVE(IVE_IMAGE_S *pstSrcImage, IVE_IMAGE_S *pstDstImage)
{
    ...
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "Error(%#x), HI_MPI_IVE_Query failed!\n", s32Ret);
FAIL_0:
...
static HI_S32 goTurnImagePreprocessByIVE(IVE_IMAGE_S *pstSrcImage, IVE_IMAGE_S *pstDstImage)
{
    ...
    if ((pstSrcImage->u32Height != u32Height) || (pstSrcImage->u32Width != u32Width)) {
        ...
        SAMPLE_CHK_GOTO((s32Ret != HI_SUCCESS), FAIL_0, "resizeImageByIVE fail:%#x\n", s32Ret);

        s32Ret = meanImageByIVE(&stResizeImage, pstDstImage);
        SAMPLE_CHK_GOTO((s32Ret != HI_SUCCESS), FAIL_0, "meanImageByIVE fail:%#x\n", s32Ret);
...
static HI_S32 goTurnReadInputDataByIVE(IVE_IMAGE_S *pstSrcImage, HI_RUNTIME_BLOB_S *pstBlobs, HI_U16 index)
{
    ...
    SAMPLE_CHK_GOTO(s32Ret != HI_SUCCESS, FAIL_0, "goTurnImagePreprocessByIVE fail:%#x\n", s32Ret);
    ...
    HI_S32 *ps32RegionW, HI_S32 *ps32RegionH)
{
    ...
    for (HI_U32 i = 0; i < pstBboxBlob->u32Num; i++) {
        ...
        printf("location %d: (%f,%f)(%f,%f)\n", i, stBboxLocation.x1, stBboxLocation.y1, stBboxLocation.x2,
               stBboxLocation.y2);
