...
typedef struct {
    hi_u32 max_stat_dout[2][DEFOG_ZONE_NUM];
    hi_u32 min_dout[2][DEFOG_ZONE_NUM / 2];
} isp_dehaze_stat;
...
typedef struct hiISP_FSWDR_USR_CFG_S {
    ...
    HI_U8 u8Mot0SigGwgt;  // u5.0, [0,31]
    HI_U8 u8Mot1SigGwgt;  // u5.0, [0,31]
    HI_U8 u8Mot2SigGwgtLow;  // u5.0, [0,31]
    HI_U8 u8Mot2SigGwgtHigh;  // u5.0, [0,31]

    HI_U8 u8Mot0SigCwgt;  // u5.0, [0,31]
    HI_U8 u8Mot1SigCwgt;  // u5.0, [0,31]
    HI_U8 u8Mot2SigCwgtLow;  // u5.0, [0,31]
    HI_U8 u8Mot2SigCwgtHigh;  // u5.0, [0,31]

    HI_U16 u16SharpedgeLowThd;  // u11.0,[0,4095]
    HI_U16 u16SharpedgeHighThd;  // u12.0,[0,4095]

    HI_BOOL bSBNRTextHigThd;  // u1.0, [0,1]
    HI_U8 u8SBNRTextLowThd;  // u1.4,[0,16]
    ...
    HI_U8 u8Gsigma_gain1;  // u8.0, [0,255]
    HI_U8 u8Csigma_gain1;  // u8.0, [0,255]
    HI_U8 u8Gsigma_gain2;  // u8.0, [0,255]
    HI_U8 u8Gsigma_gain3;  // u8.0, [0,255]

    HI_U8 u8Csigma_gain2;  // u8.0, [0,255]
    HI_U8 u8Csigma_gain3;  // u8.0, [0,255]
} ISP_FSWDR_USR_CFG_S;
...
typedef struct hiISP_FSWDR_DYNA_CFG_S {
    ...
    HI_U32 u32FusionSatMapDiffThd;  // u14.0, [0,16383]
    HI_U32 u32FusionSmoothDiffCnt;  // u4.0, [0,15]
...
typedef struct hiISP_BAYERNR_STATIC_CFG_S {
    ...
    HI_BOOL bSkipLevel5Enable;  // u1.0
...
#define HI_ISP_CLUT_LUT0                (729)
#define HI_ISP_CLUT_LUT1                (648)
#define HI_ISP_CLUT_LUT2                (648)
#define HI_ISP_CLUT_LUT3                (576)
#define HI_ISP_CLUT_LUT4                (648)
#define HI_ISP_CLUT_LUT5                (576)
#define HI_ISP_CLUT_LUT6                (576)
#define HI_ISP_CLUT_LUT7                (512)
...
#define ISP_PIPE_FEAF_MODULE_ENABLE     1, 1, 0, 0, 0
#define ISP_PIPE_FELOGLUT_MODULE_ENABLE 0, 1, 0, 0, 0
