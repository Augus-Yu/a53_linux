...
void imx290_init(VI_PIPE ViPipe)
{
    ...
    if (bInit == HI_FALSE) {
        if (enWDRMode == WDR_MODE_2To1_LINE) {
            if (u8ImgMode == IMX290_SENSOR_1080P_30FPS_2t1_WDR_MODE) { /* IMX290_SENSOR_1080P_30FPS_2t1_WDR_MODE */
                imx290_wdr_1080p60_2to1_init(ViPipe);
            } else if (u8ImgMode == IMX290_SENSOR_720P_30FPS_2t1_WDR_MODE) { /* IMX290_SENSOR_720P_30FPS_2t1_WDR_MODE */
                imx290_wdr_720p60_2to1_init(ViPipe);
            } else {
            }
        } else if (enWDRMode == WDR_MODE_3To1_LINE) {
