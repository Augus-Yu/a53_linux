...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int isp_dis_refinfo_rstt : 30; /* [29..0]  */
        unsigned int reserved_0 : 2; /* [31..30]  */
    } bits;
...
typedef struct {
    ...
    volatile U_ISP_DIS_REFINFO_RSTT ISP_DIS_REFINFO_RSTT[3072]; /* 0xacf0~0xdcec   */
    volatile U_ISP_LA_AVER ISP_LA_AVER[256]; /* 0xdcf0~0xe0ec   */
    volatile U_ISP_FLICK_GR_DIFF_CUR_RSTT ISP_FLICK_GR_DIFF_CUR_RSTT; /* 0xe0f0          */
    volatile U_ISP_FLICK_GB_DIFF_CUR_RSTT ISP_FLICK_GB_DIFF_CUR_RSTT; /* 0xe0f4          */
    volatile U_ISP_FLICK_GR_ABS_CUR_RSTT ISP_FLICK_GR_ABS_CUR_RSTT; /* 0xe0f8          */
    volatile U_ISP_FLICK_GB_ABS_CUR_RSTT ISP_FLICK_GB_ABS_CUR_RSTT; /* 0xe0fc          */
    volatile U_ISP_FLICK_GMEAN ISP_FLICK_GMEAN[512]; /* 0xe100~0xe8fc   */
    volatile U_ISP_GE_MEM_AVER0_RSTT ISP_GE_MEM_AVER0_RSTT[256]; /* 0xe900~0xecfc   */
    volatile U_ISP_GE_MEM_AVER1_RSTT ISP_GE_MEM_AVER1_RSTT[256]; /* 0xed00~0xf0fc   */
    volatile U_ISP_FPN_STAT_RSTT ISP_FPN_STAT_RSTT; /* 0xf100 */
    volatile U_ISP_FPN_SUM0_RSTT ISP_FPN_SUM0_RSTT; /* 0xf104 */
    volatile U_ISP_FPN_SUM1_RSTT ISP_FPN_SUM1_RSTT; /* 0xf108 */
    volatile U_ISP_FPN_LINE_RSTT ISP_FPN_LINE_RSTT[4096]; /* 0xf10c~0x13108  */
    volatile U_ISP_DPC_BPT_CALIB_NUMBER_RSTT ISP_DPC_BPT_CALIB_NUMBER_RSTT; /* 0x1310c         */
    volatile U_ISP_DPC_BPT_RSTT ISP_DPC_BPT_RSTT[4096]; /* 0x13110~0x1710c */
    volatile U_ISP_LDCI_GROBAL_MAP_RSTT ISP_LDCI_GROBAL_MAP_RSTT; /* 0x17110         */
    volatile U_ISP_LDCI_LPF_MAP_RSTT ISP_LDCI_LPF_MAP_RSTT[1024]; /* 0x17114~0x18110 */
    volatile U_ISP_DRC_PPDTC_SUM_RSTT ISP_DRC_PPDTC_SUM_RSTT; /* 0x18114         */
    volatile U_ISP_DEHAZE_MINSTAT ISP_DEHAZE_MINSTAT[512]; /* 0x18118~0x18914 */
    volatile U_ISP_DEHAZE_MAXSTAT ISP_DEHAZE_MAXSTAT[1024]; /* 0x18918~0x19914 */
    volatile U_ISP_Y_SUM0_RSTT ISP_Y_SUM0_RSTT; /* 0x19918         */
    volatile U_ISP_Y_SUM1_RSTT ISP_Y_SUM1_RSTT; /* 0x1991c         */
...
typedef struct {
    ...
    volatile U_ISP_AF_STAT_H1 ISP_AF_STAT_H1[255]; /* 0x1800~0x1bf8  */
    volatile unsigned int reserved_0; /* 0x1bfc         */
    volatile U_ISP_AF_STAT_H2 ISP_AF_STAT_H2[255]; /* 0x1c00~0x1ff8  */
    volatile unsigned int reserved_1; /* 0x1ffc         */
    volatile U_ISP_AF_STAT_V1 ISP_AF_STAT_V1[255]; /* 0x2000~0x23f8  */
    volatile unsigned int reserved_2; /* 0x23fc         */
    volatile U_ISP_AF_STAT_V2 ISP_AF_STAT_V2[255]; /* 0x2400~0x27f8  */
    volatile unsigned int reserved_3; /* 0x27fc         */
    volatile U_ISP_AF_STAT_Y ISP_AF_STAT_Y[255]; /* 0x2800~0x2bf8  */
    volatile unsigned int reserved_4; /* 0x2bfc         */
    volatile U_ISP_AWB_STAT ISP_AWB_STAT[8192]; /* 0x2c00~0xabfc  */
    volatile U_ISP_LA_AVER ISP_LA_AVER[256]; /* 0xac00~0xaffc  */
    volatile U_ISP_DEHAZE_MINSTAT ISP_DEHAZE_MINSTAT[512]; /* 0xb000~0xb7fc  */
    volatile U_ISP_DEHAZE_MAXSTAT ISP_DEHAZE_MAXSTAT[1024]; /* 0xb800~0xc7fc  */
    volatile U_ISP_DIS_H_STAT_RSTT ISP_DIS_H_STAT_RSTT[27]; /* 0xc800~0xc868  */
    volatile unsigned int reserved_5[37]; /* 0xc86c~0xc8fc  */
    volatile U_ISP_DIS_V_STAT_RSTT ISP_DIS_V_STAT_RSTT[27]; /* 0xc900~0xc968  */
    volatile unsigned int reserved_6[37]; /* 0xc96c~0xc9fc  */
    volatile U_ISP_FLICK_GMEAN ISP_FLICK_GMEAN[512]; /* 0xca00~0xd1fc   */
