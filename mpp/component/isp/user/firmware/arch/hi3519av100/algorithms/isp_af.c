...
HI_S32 ISP_SetAfFeDefault(VI_PIPE ViPipe, isp_reg_cfg *pstRegCfg)
{
    HI_U8 u8I, u8Shift0;
    HI_S16 s16G0, s16G1, s16G2;
    ISP_AF_H_PARAM_S *pstIIR = HI_NULL;
    ...
    pstAFdefaultCfg = &pstRegCfg->alg_reg_cfg[0].stFEAfRegCfg;
    ...
    pstAFdefaultCfg->u16OffsetGr = sns_black_level->black_level[2] << 2;
    pstAFdefaultCfg->u16OffsetGb = sns_black_level->black_level[1] << 2;
...
HI_S32 ISP_AfFeCfgRegs(VI_PIPE ViPipe, isp_reg_cfg *pstRegCfg)
{
    ISP_AF_REG_CFG_S *pstAFdefaultCfg = HI_NULL;
    hi_isp_cmos_black_level *sns_black_level = HI_NULL;
    pstAFdefaultCfg = &pstRegCfg->alg_reg_cfg[0].stFEAfRegCfg;
    ...
    /* AF FE STATISTICS CONIFG START */
    pstAFdefaultCfg->bAfEnable = (hi_ext_system_af_enable_read(ViPipe) & 0x1);
...
HI_S32 ISP_AfInit(VI_PIPE ViPipe, HI_VOID *pRegCfg)
{
    ...
    ISP_SetAfFeDefault(ViPipe, (isp_reg_cfg *)pRegCfg);
                 ...
                 HI_VOID *pRegCfg, HI_S32 s32Rsv)
{
    ...
    if (hi_ext_af_set_flag_read(ViPipe) == HI_EXT_AF_SET_FLAG_ENABLE) {
        hi_ext_af_set_flag_write(ViPipe, HI_EXT_AF_SET_FLAG_DISABLE);
        ISP_AfFeCfgRegs(ViPipe, (isp_reg_cfg *)pRegCfg);
