...
// PWMI
#define PWM0_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM0_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM0_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM0_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM0_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM0_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM0_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM1_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM1_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM1_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM1_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM1_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM1_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM1_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM2_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM2_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM2_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM2_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM2_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM2_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM2_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM3_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM3_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM3_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM3_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM3_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM3_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM3_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM4_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM4_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM4_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM4_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM4_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM4_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM4_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM5_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM5_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM5_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM5_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM5_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM5_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM5_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM6_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM6_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM6_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM6_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM6_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM6_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM6_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)

#define PWM7_CFG_REG0   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM7_CFG_REG1   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM7_CFG_REG2   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM7_CTRL_REG   HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM7_STATE_REG0 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM7_STATE_REG1 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
#define PWM7_STATE_REG2 HI_IO_PWMI_ADDRESS(PWMI_ADRESS_BASE + 0x0064)
...
int PWM_DRV_Write(unsigned char pwm_num, unsigned int duty, unsigned int period, unsigned char enable)
{
    ...
    if (enable) {
        switch (pwm_num) {
            ...
            case 3:
                regVal = (duty << 16) + (period << 4) + 1;
                PWM_WRITE_REG(PWM3_CFG_REG0, regVal);
