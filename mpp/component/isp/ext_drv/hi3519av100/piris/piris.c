...
#define PIRIS_CFG_REG(dev) HI_IO_PIRISI_ADDRESS(dev, PIRISI_ADRESS_BASE + 0x003C)
#define PIRIS_CTRL_REG(dev) HI_IO_PIRISI_ADDRESS(dev, PIRISI_ADRESS_BASE + 0x0400)
...
int PIRIS_DRV_Write(int dev, unsigned char bits)
{
    switch (bits) {
        case 0:
            PIRIS_WRITE_REG(PIRIS_CTRL_REG(dev), 0xF);
            PIRIS_WRITE_REG(PIRIS_CFG_REG(dev), 0x5);
            break;

        case 1:
            PIRIS_WRITE_REG(PIRIS_CTRL_REG(dev), 0xF);
            PIRIS_WRITE_REG(PIRIS_CFG_REG(dev), 0x6);
            break;

        case 2:
            PIRIS_WRITE_REG(PIRIS_CTRL_REG(dev), 0xF);
            PIRIS_WRITE_REG(PIRIS_CFG_REG(dev), 0xA);
            break;

        case 3:
            PIRIS_WRITE_REG(PIRIS_CTRL_REG(dev), 0xF);
            PIRIS_WRITE_REG(PIRIS_CFG_REG(dev), 0x9);
