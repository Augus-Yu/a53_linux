...
#define VOU_REGS_ADDR   0x04700000
...
HI_VOID HAL_VOU_Init(HI_VOID)
{
    if (g_pHifbReg == HI_NULL) {
        g_pHifbReg = (volatile S_VDP_REGS_TYPE *)osal_ioremap(VOU_REGS_ADDR, (HI_U32)VOU_REGS_SIZE);
    }
...
HI_VOID HAL_LINK_GetHcLink(HI_U32 *pu32Data)
{
    ...
    *pu32Data = LINK_CTRL.bits.gchn3_link;
...
HI_BOOL HAL_LAYER_EnableLayer(HAL_DISP_LAYER_E enLayer, HI_U32 bEnable)
{
    ...
    switch (enLayer) {
        ...
        case HAL_DISP_LAYER_VHD1:
        case HAL_DISP_LAYER_VHD2: {
            addr_REG = Vou_GetAbsAddr(enLayer, (HI_UL) & (g_pHifbReg->V0_CTRL.u32));
...
HI_VOID HAL_LAYER_CSC_SetEnable(HAL_DISP_LAYER_E enLayer, HI_BOOL csc_en)
{
    ...
    if (enLayer >= LAYER_GFX_START && enLayer <= LAYER_GFX_END) {
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_CTRL.u32));
...
HI_VOID HAL_LAYER_CSC_SetCoef(HAL_DISP_LAYER_E enLayer, VDP_CSC_COEF_S *pstCscCoef)
{
    ...
    if (enLayer >= HAL_DISP_LAYER_GFX0 && enLayer <= HAL_DISP_LAYER_GFX3) {
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF00.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF01.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF02.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF10.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF11.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF12.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF20.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF21.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_COEF22.u32));
...
HI_VOID HAL_LAYER_CSC_SetDcCoef(HAL_DISP_LAYER_E enLayer, VDP_CSC_DC_COEF_S *pstCscDcCoef)
{
    ...
    if (enLayer >= HAL_DISP_LAYER_GFX0 && enLayer <= HAL_DISP_LAYER_GFX3) {
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_IDC0.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_IDC1.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_IDC2.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_ODC0.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_ODC1.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_ODC2.u32));
...
HI_VOID HAL_LAYER_CSC_SetParam(HAL_DISP_LAYER_E enLayer, CscCoefParam_S *pstCoefParam)
{
    ...
    if (enLayer >= LAYER_GFX_START && enLayer <= LAYER_GFX_END) {
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_SCALE.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_MIN_Y.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_MIN_C.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_MAX_Y.u32));
        ...
        addr_REG = Vou_GetAbsAddr(enLayer, (HI_U32) & (g_pHifbReg->G0_HIPP_CSC_MAX_C.u32));
...
HI_BOOL HAL_LAYER_SetRegUp(HAL_DISP_LAYER_E enLayer)
{
    ...
    switch (enLayer) {
        ...
        case HAL_DISP_LAYER_VHD1:
        case HAL_DISP_LAYER_VHD2: {
            addr_REG = Vou_GetAbsAddr(enLayer, (HI_UL) & (g_pHifbReg->V0_UPD.u32));
...
{
    U_GFX_DCMP_CTRL GFX_DCMP_CTRL;

    if (layer >= GFX_MAX) {
        HI_TRACE(HI_DBG_ERR, HI_ID_FB, "Error, %s(),%d Select Wrong Layer ID\n", __FUNCTION__, __LINE__);
    }

    GFX_DCMP_CTRL.u32 = HAL_ReadReg((HI_U32 *)(&(g_pHifbReg->GFX_DCMP_CTRL.u32) + layer * FDR_GFX_OFFSET));
    GFX_DCMP_CTRL.bits.osd_mode = source_mode;
    HAL_WriteReg ((HI_U32 *)(&(g_pHifbReg->GFX_DCMP_CTRL.u32) + layer * FDR_GFX_OFFSET), GFX_DCMP_CTRL.u32);
