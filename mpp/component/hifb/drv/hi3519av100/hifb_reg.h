...
typedef struct {
    ...
    volatile unsigned int reserved_1[568]; /* 0x20~0x8fc */
    volatile unsigned int reserved_2[192]; /* 0x900~0xbfc */
    volatile U_LINK_CTRL LINK_CTRL; /* 0xc00 */
    volatile unsigned int reserved_3[139]; /* 0xc04~0xe2c */
    volatile unsigned int PARA_HADDR_VHD_CHN06; /* 0xe30 */
    volatile unsigned int PARA_ADDR_VHD_CHN06; /* 0xe34 */
    volatile unsigned int reserved_4[50]; /* 0xe38~0xefc */
    volatile U_PARA_UP_VHD PARA_UP_VHD; /* 0xf00 */
    volatile unsigned int reserved_5[63]; /* 0xf04~0xffc */
    volatile U_V0_CTRL V0_CTRL; /* 0x1000 */
    volatile U_V0_UPD V0_UPD; /* 0x1004 */
    volatile unsigned int reserved_6[1022]; /* 0x1008~0x1ffc */
    volatile unsigned int reserved_7[1024]; /* 0x2000~0x2ffc */
    volatile unsigned int reserved_8[4096]; /* 0x3000~0x6ffc */
    ...
    volatile unsigned int reserved_9[28]; /* 0x7010~0x707c */
    ...
    volatile unsigned int reserved_10[28]; /* 0x7090~0x70fc */
    volatile U_G0_HIPP_CSC_CTRL G0_HIPP_CSC_CTRL; /* 0x7100 */
    volatile U_G0_HIPP_CSC_COEF00 G0_HIPP_CSC_COEF00; /* 0x7104 */
    volatile U_G0_HIPP_CSC_COEF01 G0_HIPP_CSC_COEF01; /* 0x7108 */
    volatile U_G0_HIPP_CSC_COEF02 G0_HIPP_CSC_COEF02; /* 0x710c */
    volatile U_G0_HIPP_CSC_COEF10 G0_HIPP_CSC_COEF10; /* 0x7110 */
    volatile U_G0_HIPP_CSC_COEF11 G0_HIPP_CSC_COEF11; /* 0x7114 */
    volatile U_G0_HIPP_CSC_COEF12 G0_HIPP_CSC_COEF12; /* 0x7118 */
    volatile U_G0_HIPP_CSC_COEF20 G0_HIPP_CSC_COEF20; /* 0x711c */
    volatile U_G0_HIPP_CSC_COEF21 G0_HIPP_CSC_COEF21; /* 0x7120 */
    volatile U_G0_HIPP_CSC_COEF22 G0_HIPP_CSC_COEF22; /* 0x7124 */
    volatile U_G0_HIPP_CSC_SCALE G0_HIPP_CSC_SCALE; /* 0x7128 */
    volatile U_G0_HIPP_CSC_IDC0 G0_HIPP_CSC_IDC0; /* 0x712c */
    volatile U_G0_HIPP_CSC_IDC1 G0_HIPP_CSC_IDC1; /* 0x7130 */
    volatile U_G0_HIPP_CSC_IDC2 G0_HIPP_CSC_IDC2; /* 0x7134 */
    volatile U_G0_HIPP_CSC_ODC0 G0_HIPP_CSC_ODC0; /* 0x7138 */
    volatile U_G0_HIPP_CSC_ODC1 G0_HIPP_CSC_ODC1; /* 0x713c */
    volatile U_G0_HIPP_CSC_ODC2 G0_HIPP_CSC_ODC2; /* 0x7140 */
    volatile U_G0_HIPP_CSC_MIN_Y G0_HIPP_CSC_MIN_Y; /* 0x7144 */
    volatile U_G0_HIPP_CSC_MIN_C G0_HIPP_CSC_MIN_C; /* 0x7148 */
    volatile U_G0_HIPP_CSC_MAX_Y G0_HIPP_CSC_MAX_Y; /* 0x714c */
    volatile U_G0_HIPP_CSC_MAX_C G0_HIPP_CSC_MAX_C; /* 0x7150 */
    volatile U_G0_HIPP_CSC2_COEF00 G0_HIPP_CSC2_COEF00; /* 0x7154 */
    volatile U_G0_HIPP_CSC2_COEF01 G0_HIPP_CSC2_COEF01; /* 0x7158 */
    volatile U_G0_HIPP_CSC2_COEF02 G0_HIPP_CSC2_COEF02; /* 0x715c */
    volatile U_G0_HIPP_CSC2_COEF10 G0_HIPP_CSC2_COEF10; /* 0x7160 */
    volatile U_G0_HIPP_CSC2_COEF11 G0_HIPP_CSC2_COEF11; /* 0x7164 */
    volatile U_G0_HIPP_CSC2_COEF12 G0_HIPP_CSC2_COEF12; /* 0x7168 */
    volatile U_G0_HIPP_CSC2_COEF20 G0_HIPP_CSC2_COEF20; /* 0x716c */
    volatile U_G0_HIPP_CSC2_COEF21 G0_HIPP_CSC2_COEF21; /* 0x7170 */
    volatile U_G0_HIPP_CSC2_COEF22 G0_HIPP_CSC2_COEF22; /* 0x7174 */
    volatile U_G0_HIPP_CSC2_SCALE G0_HIPP_CSC2_SCALE; /* 0x7178 */
    volatile U_G0_HIPP_CSC2_IDC0 G0_HIPP_CSC2_IDC0; /* 0x717c */
    volatile U_G0_HIPP_CSC2_IDC1 G0_HIPP_CSC2_IDC1; /* 0x7180 */
    volatile U_G0_HIPP_CSC2_IDC2 G0_HIPP_CSC2_IDC2; /* 0x7184 */
    volatile U_G0_HIPP_CSC2_ODC0 G0_HIPP_CSC2_ODC0; /* 0x7188 */
    volatile U_G0_HIPP_CSC2_ODC1 G0_HIPP_CSC2_ODC1; /* 0x718c */
    volatile U_G0_HIPP_CSC2_ODC2 G0_HIPP_CSC2_ODC2; /* 0x7190 */
    volatile U_G0_HIPP_CSC2_MIN_Y G0_HIPP_CSC2_MIN_Y; /* 0x7194 */
    volatile U_G0_HIPP_CSC2_MIN_C G0_HIPP_CSC2_MIN_C; /* 0x7198 */
    volatile U_G0_HIPP_CSC2_MAX_Y G0_HIPP_CSC2_MAX_Y; /* 0x719c */
    volatile U_G0_HIPP_CSC2_MAX_C G0_HIPP_CSC2_MAX_C; /* 0x71a0 */
    volatile unsigned int reserved_11[19]; /* 0x71a4~0x71ec */
    volatile U_G0_HIPP_CSC_INK_CTRL G0_HIPP_CSC_INK_CTRL; /* 0x71f0 */
    volatile U_G0_HIPP_CSC_INK_POS G0_HIPP_CSC_INK_POS; /* 0x71f4 */
    volatile unsigned int G0_HIPP_CSC_INK_DATA; /* 0x71f8 */
    volatile unsigned int G0_HIPP_CSC_INK_DATA2; /* 0x71fc */
    volatile unsigned int reserved_12[64]; /* 0x7200~0x72fc */
    ...
    volatile unsigned int reserved_15[5917]; /* 0x738c~0xcffc */
    ...
    volatile unsigned int DHD0_VTTHD3; /* 0xd020 */
    volatile U_DHD0_VTTHD DHD0_VTTHD; /* 0xd024 */
    volatile unsigned int reserved_16[4]; /* 0xd028~0xd034 */
    volatile U_DHD0_PARAUP DHD0_PARAUP; /* 0xd038 */
    volatile unsigned int reserved_17[19]; /* 0xd03c~0xd084 */
    volatile U_DHD0_STATE DHD0_STATE; /* 0xd088 */
    volatile unsigned int reserved_18; /* 0xd08c */
    volatile U_VO_MUX VO_MUX; /* 0xd090 */
    volatile unsigned int reserved_19[3931]; /* 0xd094~0x10dfc */
    ...
    volatile unsigned int reserved_20[7]; /* 0x10e0c~0x10e24 */
    volatile U_GFX_1555_ALPHA GFX_1555_ALPHA; /* 0x10e28 */
    volatile unsigned int reserved_21[5]; /* 0x10e2c~0x10e3c */
    ...
    volatile unsigned int reserved_22[2]; /* 0x10e58~0x10e5c */
    volatile U_GFX_STRIDE GFX_STRIDE; /* 0x10e60 */
    volatile unsigned int reserved_23[3]; /* 0x10e64~0x10e6c */
    volatile unsigned int GFX_DCMP_ADDR_H; /* 0x10e70 */
    volatile unsigned int GFX_DCMP_ADDR_L; /* 0x10e74 */
    volatile unsigned int reserved_24[34]; /* 0x10e78~0x10efc */
    ...
    volatile unsigned int reserved_25[29]; /* 0x10f0c~0x10f7c */
