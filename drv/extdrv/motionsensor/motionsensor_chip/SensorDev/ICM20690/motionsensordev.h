...
{
    hi_msensor_magn_config stMagnConfig;
    hi_u32        u32BandWidth;
    hi_u64        u64LastPts;
} MAGN_STATUS_S;
...
{
    hi_msensor_sample_data  accel_cur_data;
    hi_msensor_sample_data  gyro_cur_data;
...
//struct ICM20690_dev_info *ICM20690_dev;
...
hi_void   HI_MotionSensor_DevDeInit(hi_msensor_param* MotionSensor_status);
hi_s32    HI_MotionSensor_SensorInit(hi_void);
hi_void   HI_MotionSensor_SensorDeInit(hi_msensor_param* pstMSensorParam);
...
//hi_s32    HI_MOTIONSENSOR_SaveData_ModeDofFifo(hi_msensor_attr attr, hi_msensor_data* pstIMUdata);
