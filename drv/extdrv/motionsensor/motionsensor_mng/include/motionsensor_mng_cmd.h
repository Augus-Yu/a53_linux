...
#define MSENSOR_CMD_GET_DATA          _IOWR(MSENSOR_TYPE_MNG, 1,  hi_msensor_data_info)
#define MSENSOR_CMD_RELEASE_BUF       _IOWR(MSENSOR_TYPE_MNG, 2,  hi_msensor_data_info)
...
#define MSENSOR_CMD_SEND_DATA         _IOW(MSENSOR_TYPE_MNG, 5,   hi_msensor_data)
