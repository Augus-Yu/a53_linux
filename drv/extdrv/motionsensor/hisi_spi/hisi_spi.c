...
#define SSP_BASE 0x04570000
#define SSP_SIZE 0x10000  // 64KB

#define CRG_BASE       0x04510000
#define CRG_SIZE       0x1000
#define SSP_CRG_OFFSET 0x0198

static void __iomem *reg_ssp_base_va;
static void __iomem *reg_crg_base_va;
#define IO_ADDRESS_VERIFY(x) ((hi_ulong)reg_ssp_base_va + ((x) - (SSP_BASE)))
#define SSP_CRG_ADDRESS      ((hi_ulong)reg_crg_base_va + SSP_CRG_OFFSET)
 ...
 *
 */
static int hi_ssp_set_frameform(unsigned int ssp_no, unsigned char framemode, unsigned char spo, unsigned char sph,
...
unsigned short hi_motionsensor_ssp_read_alt(unsigned int ssp_no, hi_u8 u8reg_addr, hi_u8 *u8reg_data,
                                            hi_u32 u32cnt, hi_bool bFifoMode)
{
    unsigned int ret = 0;
    unsigned long flags;
    hi_u8 buf[2] = { 0 };
