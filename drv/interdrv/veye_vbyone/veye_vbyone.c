			      ...
			      struct thcv242a_priv *priv)
{
    ...
    if(err) {
        ...
        thcv241a->i2c_address = 0x36;
        dev_info(dev, "%s: - i2c-address set to default val: 0x36\n",
             __func__);
    } else {
...
MODULE_AUTHOR("Yu daoyang <yudaoyang@weigaogroup.com>");
