...
static int __init veye_vbyone_driver_init(void)
{
    printk("[YDY]Into veye_vbyone_driver_init\n");
    return i2c_add_driver(&thcv242a_driver);
}
 
static void __exit veye_vbyone_driver_exit(void)
{
    return i2c_del_driver(&thcv242a_driver);
}
module_init(veye_vbyone_driver_init);
module_exit(veye_vbyone_driver_exit);
