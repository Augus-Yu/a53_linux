...
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    phy_da_ulpb_ck        : 1   ; /* [0]  */
        unsigned int    phy_da_ulpb_ck2       : 1   ; /* [1]  */
        unsigned int    phy_da_idlb_clk       : 1   ; /* [2]  */
        unsigned int    phy_da_idlb_clk2      : 1   ; /* [3]  */
...
typedef union {
    ...
    struct {
        ...
        unsigned int    err0_escape_ck_raw    : 1   ; /* [4]  */
        ...
        unsigned int    err0_timeout_ck_raw   : 1   ; /* [12]  */
...
typedef union {
    ...
    struct {
        ...
        unsigned int    err0_escape_ck_st     : 1   ; /* [4]  */
        unsigned int    reserved_0            : 3   ; /* [7..5]  */
        ...
        unsigned int    err0_timeout_ck_st    : 1   ; /* [12]  */
        unsigned int    reserved_1            : 19  ; /* [31..13]  */
    } bits;
...
typedef union {
    ...
    struct {
        ...
        unsigned int    err3_escape_ck_msk    : 1   ; /* [4]  */
        unsigned int    reserved_0            : 3   ; /* [7..5]  */
        ...
        unsigned int    err3_timeout_ck_msk   : 1   ; /* [12]  */
        unsigned int    reserved_1            : 19  ; /* [31..13]  */
    } bits;
...
typedef union {
    ...
    struct {
        ...
        unsigned int    reserved_0            : 3   ; /* [3..1]  */
        unsigned int    chn0_mem_rct          : 2   ; /* [5..4]  */
        unsigned int    reserved_1            : 2   ; /* [7..6]  */
        unsigned int    chn0_mem_wct          : 2   ; /* [9..8]  */
        unsigned int    reserved_2            : 2   ; /* [11..10]  */
        unsigned int    chn0_mem_kp           : 3   ; /* [14..12]  */
...
typedef union {
    ...
    struct {
        ...
        unsigned int    reserved_0            : 3   ; /* [3..1]  */
        unsigned int    chn1_mem_rct          : 2   ; /* [5..4]  */
        unsigned int    reserved_1            : 2   ; /* [7..6]  */
        unsigned int    chn1_mem_wct          : 2   ; /* [9..8]  */
        unsigned int    reserved_2            : 2   ; /* [11..10]  */
        unsigned int    chn1_mem_kp           : 3   ; /* [14..12]  */
        unsigned int    reserved_3            : 17  ; /* [31..15]  */
    } bits;
...
typedef union {
    ...
    struct {
        ...
        unsigned int    reserved_0            : 3   ; /* [3..1]  */
        unsigned int    chn2_mem_rct          : 2   ; /* [5..4]  */
        unsigned int    reserved_1            : 2   ; /* [7..6]  */
        unsigned int    chn2_mem_wct          : 2   ; /* [9..8]  */
        unsigned int    reserved_2            : 2   ; /* [11..10]  */
        unsigned int    chn2_mem_kp           : 3   ; /* [14..12]  */
        unsigned int    reserved_3            : 17  ; /* [31..15]  */
    } bits;
...
typedef union {
    ...
    struct {
        ...
        unsigned int    reserved_0            : 3   ; /* [3..1]  */
        unsigned int    chn3_mem_rct          : 2   ; /* [5..4]  */
        unsigned int    reserved_1            : 2   ; /* [7..6]  */
        unsigned int    chn3_mem_wct          : 2   ; /* [9..8]  */
        unsigned int    reserved_2            : 2   ; /* [11..10]  */
        unsigned int    chn3_mem_kp           : 3   ; /* [14..12]  */
        unsigned int    reserved_3            : 17  ; /* [31..15]  */
    } bits;
...
/* Define the union U_CHN4_MEM_CTRL */
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    chn4_mem_ck_gt        : 1   ; /* [0]  */
        unsigned int    reserved_0            : 3   ; /* [3..1]  */
        unsigned int    chn4_mem_rct          : 2   ; /* [5..4]  */
        unsigned int    reserved_1            : 2   ; /* [7..6]  */
        unsigned int    chn4_mem_wct          : 2   ; /* [9..8]  */
        unsigned int    reserved_2            : 2   ; /* [11..10]  */
        unsigned int    chn4_mem_kp           : 3   ; /* [14..12]  */
        unsigned int    reserved_3            : 17  ; /* [31..15]  */
    } bits;
...
/* Define the union U_CHN4_CLR_EN */
typedef union {
    /* Define the struct bits */
    struct {
        unsigned int    chn4_clr_en_lvds      : 1   ; /* [0]  */
        unsigned int    chn4_clr_en_align     : 1   ; /* [1]  */
        unsigned int    reserved_0            : 30  ; /* [31..2]  */
    } bits;
...
/* Define the union U_ALIGN0_INT_RAW */
typedef union {
    /* Define the struct bits */
    struct {
...
/* Define the union U_ALIGN0_INT_MSK */
typedef union {
    /* Define the struct bits */
    struct {
...
typedef struct {
    ...
    volatile U_PHY_LANE_SI_LINK          PHY_LANE_SI_LINK            ; /* 0x8 */
    volatile U_PHY_EN_LINK               PHY_EN_LINK                 ; /* 0xc */
    volatile U_PHY_EQ_LINK               PHY_EQ_LINK                 ; /* 0x10 */
    ...
    volatile unsigned int                reserved_1[2]               ; /* 0x48~0x4c */
    volatile U_PHY_DESKEW_CAL_LINK       PHY_DESKEW_CAL_LINK         ; /* 0x50 */
    ...
    volatile unsigned int                reserved_3[36]              ; /* 0x70~0xfc */
    ...
    volatile U_PHY_ST4_LINK              PHY_ST4_LINK                ; /* 0x120 */
    volatile U_PHY_ST5_LINK              PHY_ST5_LINK                ; /* 0x124 */
    volatile U_PHY_ST_SO_LINK            PHY_ST_SO_LINK              ; /* 0x128 */
    ...
    volatile unsigned int                reserved_4[46]              ; /* 0x138~0x1ec */
    ...
    volatile unsigned int                reserved_5                  ; /* 0x1fc */
}mipi_rx_phy_cfg_t;
...
typedef struct {
    ...
    volatile U_PHY_LP_SELECT        PHY_LP_SELECT            ; /* 0x814 */
    ...
    volatile U_CHN2_MEM_CTRL        CHN2_MEM_CTRL            ; /* 0x830 */
    volatile U_CHN2_CLR_EN          CHN2_CLR_EN              ; /* 0x834 */
    volatile U_CHN3_MEM_CTRL        CHN3_MEM_CTRL            ; /* 0x838 */
    volatile U_CHN3_CLR_EN          CHN3_CLR_EN              ; /* 0x83c */
    volatile U_CHN4_MEM_CTRL        CHN4_MEM_CTRL            ; /* 0x840 */
    volatile U_CHN4_CLR_EN          CHN4_CLR_EN              ; /* 0x844 */
    volatile unsigned int           reserved_1[14]           ; /* 0x848~0x87c */
    volatile U_MIPI_TEST_PHY        MIPI_TEST_PHY            ; /* 0x880 */
    volatile unsigned int           reserved_2[31]           ; /* 0x884~0x8fc */
    ...
    volatile unsigned int           reserved_3[57]           ; /* 0x91c~0x9fc */
    volatile U_PHY0_TEST_OUT        PHY0_TEST_OUT            ; /* 0xa00 */
    volatile U_PHY1_TEST_OUT        PHY1_TEST_OUT            ; /* 0xa04 */
    volatile U_PHY2_TEST_OUT        PHY2_TEST_OUT            ; /* 0xa08 */
    volatile unsigned int           reserved_4[377]          ; /* 0xa0c~0xfec */
    ...
    volatile unsigned int           reserved_5               ; /* 0xffc */
}mipi_rx_sys_regs_t;
...
typedef struct {
    ...
    volatile unsigned int               reserved_7[61]          ; /* 0x110c~0x11fc */
    ...
    volatile unsigned int               reserved_12[3]          ; /* 0x1244~0x124c */
...
typedef struct {
    ...
    volatile U_LVDS_LANE_ORDERS1            LVDS_LANE_ORDERS1           ; /* 0x1794 */
    volatile U_LVDS_LANE_ORDERS2            LVDS_LANE_ORDERS2           ; /* 0x1798 */
    volatile U_LVDS_LANE_ORDERS3            LVDS_LANE_ORDERS3           ; /* 0x179c */
    ...
    volatile U_LANE_ID1_CHN                 LANE_ID1_CHN0               ; /* 0x1804 */
    volatile U_LANE_ID2_CHN                 LANE_ID2_CHN0               ; /* 0x1808 */
    volatile U_LANE_ID3_CHN                 LANE_ID3_CHN0               ; /* 0x180c */
    volatile unsigned int                   reserved_3[56]              ; /* 0x1810~0x18ec */
...
/* Define the global struct */
typedef struct {
    mipi_rx_phy_cfg_t      mipi_rx_phy_cfg[3];      /* 0x0 ~ 0x1fc, 0x200 ~ 0x3fc, 0x400 ~ 0x5fc */
    volatile unsigned int  reserved_0[128];         /* 0x600 ~ 0x7fc */
    mipi_rx_sys_regs_t     mipi_rx_sys_regs;        /* 0x800 ~ 0xffc */
    mipi_rx_ctrl_regs_t    mipi_rx_ctrl_regs[5];    /* 0x1000 ~ 0x1ffc */
} mipi_rx_regs_type_t;
