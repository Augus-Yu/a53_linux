...
typedef struct {
    ...
    /* Lane sync err */
    unsigned int lane11_sync_err_cnt;
    unsigned int lane10_sync_err_cnt;
    unsigned int lane9_sync_err_cnt;
    unsigned int lane8_sync_err_cnt;
...
typedef struct {
    unsigned int lane11_align_err_cnt;
    unsigned int lane10_align_err_cnt;
    unsigned int lane9_align_err_cnt;
    unsigned int lane8_align_err_cnt;
